    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='static\\images\\home-appliances.jpg', upload_to='category_images')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('city', models.CharField(choices=[('ALMATY', 'Almaty'), ('ASTANA', 'Astana'), ('SHYMKENT', 'Shymkent'), ('AKTOBE', 'Aktobe'), ('ATYRAU', 'Atyrau'), ('PAVLODAR', 'Pavlodar'), ('SEMEI', 'Semei')], default='ALMATY', max_length=15)),
